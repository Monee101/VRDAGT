...
#局部放大图
axins_loss = ax[0].inset_axes([0.5, 0.5, 0.2, 0.2])
...
# # 添加连接线
mark_inset(ax[0], axins_loss, loc1=3, loc2=4, fc="none", ec='0.5')
